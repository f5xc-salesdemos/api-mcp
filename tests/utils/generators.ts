 ...
 */
export const arbOperationType = fc.constantFrom(
	"create",
	"list",
	"get",
	"update",
 ...
 */
export const arbParameterType = fc.constantFrom(
	"string",
	"integer",
	"number",
	"boolean",
...
export const arbOpenApiParameter: fc.Arbitrary<OpenApiParameter> = fc.record({
	...
	in: fc.constantFrom("path", "query") as fc.Arbitrary<
...
export const arbDangerLevel = fc.option(
	fc.constantFrom("low", "medium", "high") as fc.Arbitrary<
		"low" | "medium" | "high"
	>,
	{ nil: null },
);
...
export const arbValidationRules = fc.record({
	"ves.io.schema.rules.string.max_len": fc.constantFrom(
		"64",
		"128",
		"256",
		"512",
