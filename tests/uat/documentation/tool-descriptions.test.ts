...
describe("Discovery Tool Descriptions Validation", () => {
  ...
  describe("f5xc-api-server-info tool", () => {
    it("should exist in manifest", () => {
      const tool = manifest.tools?.find((t) => t.name === "f5xc-api-server-info");
  ...
  describe("f5xc-api-search-tools tool", () => {
    it("should exist in manifest", () => {
      const tool = manifest.tools?.find((t) => t.name === "f5xc-api-search-tools");
      expect(tool).toBeDefined();
    });
  ...
  describe("f5xc-api-describe-tool tool", () => {
    it("should exist in manifest", () => {
      const tool = manifest.tools?.find((t) => t.name === "f5xc-api-describe-tool");
      expect(tool).toBeDefined();
    });
  ...
  describe("f5xc-api-execute-tool tool", () => {
    it("should exist in manifest", () => {
      const tool = manifest.tools?.find((t) => t.name === "f5xc-api-execute-tool");
      expect(tool).toBeDefined();
    });
  ...
  describe("f5xc-api-search-resources tool", () => {
    it("should exist in manifest", () => {
      const tool = manifest.tools?.find((t) => t.name === "f5xc-api-search-resources");
      expect(tool).toBeDefined();
    });
  ...
  describe("f5xc-api-execute-resource tool", () => {
    it("should exist in manifest", () => {
      const tool = manifest.tools?.find((t) => t.name === "f5xc-api-execute-resource");
      expect(tool).toBeDefined();
    });
