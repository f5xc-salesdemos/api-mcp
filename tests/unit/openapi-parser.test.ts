...
describe("openapi-parser", () => {
    ...
    it("should combine operations from multiple specs", () => {
      const specs: ParsedSpec[] = [
        ...
        },
        {
          ...
          title: "API 2",
          version: "1.0.0",
          operations: [createMockOperation("f5xc-api-dns-zone-list"), createMockOperation("f5xc-api-dns-zone-create")],
          schemas: {},
        },
      ];
  ...
  describe("groupOperationsByDomain", () => {
    ...
    it("should handle operations with no domain", () => {
      const operations: ParsedOperation[] = [createMockOperation("f5xc-api-unknown-test-list", "")];
