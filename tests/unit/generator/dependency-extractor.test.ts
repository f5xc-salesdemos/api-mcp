...
import type { AddonServiceDefinition, OneOfGroup, ResourceReference } from "../../../src/generator/dependency-types.js";
...
describe("Dependency Extractor", () => {
  ...
  describe("extractRefPatterns", () => {
    ...
    it("should extract refs from allOf", () => {
      const schema = {
        allOf: [{ $ref: "#/components/schemas/baseSpec" }, { $ref: "#/components/schemas/extendedSpec" }],
      };
    ...
    it("should extract refs from oneOf and mark as inline", () => {
      const schema = {
        oneOf: [{ $ref: "#/components/schemas/option1Spec" }, { $ref: "#/components/schemas/option2Spec" }],
      };
    ...
    it("should extract refs from anyOf and mark as inline", () => {
      const schema = {
        anyOf: [{ $ref: "#/components/schemas/variant1Spec" }, { $ref: "#/components/schemas/variant2Spec" }],
      };
