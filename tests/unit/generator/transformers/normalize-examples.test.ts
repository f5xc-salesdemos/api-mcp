...
describe("normalize-examples", () => {
	describe("normalizeExamples", () => {
		...
		it("should normalize namespace and resource names", () => {
			...
			const expected =
				"Use namespace 'example-namespace' with resource 'example-lb'";
		...
		it("should preserve text that is not my- prefixed", () => {
			const input =
				"Use my-namespace but also other-namespace and regular text";
			const expected =
				"Use example-namespace but also other-namespace and regular text";
...
Line 3 with example-third`;
		...
		it("should handle special characters around my- prefix", () => {
			...
			const expected =
				"(example-paren) [example-bracket] {example-brace} <example-angle>";
		...
		it("should handle my- prefix with numbers", () => {
			...
			const expected =
				"example-resource1, example-resource2, example-resource3";
		...
		it("should handle mixed case around my- prefix", () => {
			...
			expect(normalizeExamples(input)).toBe(
				"My-Resource MY-RESOURCE example-Resource",
			);
		});
	});
	...
	describe("normalizeParameterExamples", () => {
		it("should normalize description in parameter object", () => {
			...
			expect(result.description).toBe(
				"Use example-resource and example-namespace",
			);
...
Line 3`;
	...
	describe("Edge Cases", () => {
		it("should handle very long strings efficiently", () => {
			const longString =
				"start ".repeat(1000) + "my-resource" + " end".repeat(1000);
