...
description: Manage Static Component resources in F5 Distributed Cloud.
---

Static Component provides tools for listing, and retrieving resources in F5 Distributed Cloud.
...
```bash
# List resources
curl -X GET "https://${TENANT}.console.ves.volterra.io/api/web/namespaces/$${PARAM}/static_components" \
  -H "Authorization: APIToken ${F5XC_API_TOKEN}"

# Get specific resource
curl -X GET "https://${TENANT}.console.ves.volterra.io/api/web/namespaces/$${PARAM}/static_components/$${PARAM}" \
  -H "Authorization: APIToken ${F5XC_API_TOKEN}"
