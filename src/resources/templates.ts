 ...
 */
export function buildResourceUri(tenant: string, namespace: string, resourceType: string, name: string): string {
 ...
 * @returns API path
 */
export function buildApiPath(resourceType: string, namespace: string, name?: string): string | null {
