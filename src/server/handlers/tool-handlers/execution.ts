 ...
 */
export function registerExecuteToolTool(server: McpServer, credentialManager: CredentialManager): void {
  server.tool(
 ...
 */
export function registerExecuteResourceTool(server: McpServer, credentialManager: CredentialManager): void {
  server.tool(
 ...
 */
export function registerExecutionTools(server: McpServer, credentialManager: CredentialManager): void {
