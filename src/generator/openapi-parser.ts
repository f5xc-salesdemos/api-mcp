 ...
 */
function extractCurlExamplesFromSchemas(schemas: Record<string, unknown> | undefined): Map<string, string> {
 ...
 */
export function groupOperationsByDomain(operations: ParsedOperation[]): Map<string, ParsedOperation[]> {
