	...
	},
	{
		...
		oneOfGroups: [
			...
			},
			{
				...
				fieldPath:
					"spec.job.containers[].liveness_check.http_health_check.port.port_choice",
				options: [
			...
			},
			{
				choiceField: "port_choice",
				fieldPath:
					"spec.job.containers[].liveness_check.tcp_health_check.port.port_choice",
				options: [
			...
			},
			{
				choiceField: "port_choice",
				fieldPath:
					"spec.job.containers[].readiness_check.http_health_check.port.port_choice",
				options: [
			...
			},
			{
				choiceField: "port_choice",
				fieldPath:
					"spec.job.containers[].readiness_check.tcp_health_check.port.port_choice",
				options: [
			...
			},
			{
				...
				fieldPath:
					"spec.job.volumes[].persistent_volume.storage.class_name_choice",
				options: [
			...
			},
			{
				choiceField: "choice",
				fieldPath:
					"spec.service.advertise_options.advertise_custom.advertise_where[].choice",
				options: [
			...
			},
			{
				choiceField: "advertise_choice",
				fieldPath:
					"spec.service.advertise_options.advertise_custom.ports[].advertise_choice",
				options: [
			...
			},
			{
				choiceField: "port_choice",
				fieldPath:
					"spec.service.advertise_options.advertise_in_cluster.port_choice",
				options: [
			...
			},
			{
				choiceField: "advertise_choice",
				fieldPath:
					"spec.service.advertise_options.advertise_on_public.advertise_choice",
				options: [
			...
			},
			{
				choiceField: "advertise_choice",
				fieldPath:
					"spec.service.advertise_options.advertise_on_public.port.advertise_choice",
				options: [
			...
			},
			{
				choiceField: "health_check_choice",
				fieldPath:
					"spec.service.containers[].liveness_check.health_check_choice",
				options: [
			...
			},
			{
				choiceField: "port_choice",
				fieldPath:
					"spec.service.containers[].liveness_check.http_health_check.port.port_choice",
				options: [
			...
			},
			{
				choiceField: "port_choice",
				fieldPath:
					"spec.service.containers[].liveness_check.tcp_health_check.port.port_choice",
				options: [
			...
			},
			{
				choiceField: "health_check_choice",
				fieldPath:
					"spec.service.containers[].readiness_check.health_check_choice",
				options: [
			...
			},
			{
				choiceField: "port_choice",
				fieldPath:
					"spec.service.containers[].readiness_check.http_health_check.port.port_choice",
				options: [
			...
			},
			{
				choiceField: "port_choice",
				fieldPath:
					"spec.service.containers[].readiness_check.tcp_health_check.port.port_choice",
				options: [
			...
			},
			{
				choiceField: "class_name_choice",
				fieldPath:
					"spec.service.volumes[].persistent_volume.storage.class_name_choice",
				options: [
			...
			},
			{
				...
				options: [
					"spec.simple_service.do_not_advertise",
					"spec.simple_service.simple_advertise",
				],
			},
			{
			...
			},
			{
				choiceField: "health_check_choice",
				fieldPath:
					"spec.simple_service.container.liveness_check.health_check_choice",
				options: [
			...
			},
			{
				choiceField: "port_choice",
				fieldPath:
					"spec.simple_service.container.liveness_check.tcp_health_check.port.port_choice",
				options: [
			...
			},
			{
				choiceField: "health_check_choice",
				fieldPath:
					"spec.simple_service.container.readiness_check.health_check_choice",
				options: [
			...
			},
			{
				choiceField: "class_name_choice",
				fieldPath:
					"spec.simple_service.enabled.persistent_volume.storage.class_name_choice",
				options: [
			...
			},
			{
				...
				options: [
					"spec.stateful_service.num_replicas",
					"spec.stateful_service.scale_to_zero",
				],
			},
			{
				choiceField: "advertise_choice",
			...
			},
			{
				choiceField: "port_choice",
				fieldPath:
					"spec.stateful_service.advertise_options.advertise_in_cluster.port_choice",
				options: [
			...
			},
			{
				choiceField: "advertise_choice",
				fieldPath:
					"spec.stateful_service.advertise_options.advertise_on_public.advertise_choice",
				options: [
			...
			},
			{
				choiceField: "health_check_choice",
				fieldPath:
					"spec.stateful_service.containers[].liveness_check.health_check_choice",
				options: [
			...
			},
			{
				choiceField: "health_check_choice",
				fieldPath:
					"spec.stateful_service.containers[].readiness_check.health_check_choice",
				options: [
