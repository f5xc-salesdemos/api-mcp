	...
	},
	{
		...
		oneOfGroups: [
			...
			},
			{
				...
				fieldPath:
					"spec.rules[].match.ip_prefixes.prefixes[].prefix_length_match",
				options: [
	...
	},
	{
		...
		oneOfGroups: [
			...
			},
			{
				...
				fieldPath:
					"spec.enable_forward_proxy.tls_intercept.interception_policy_choice",
				options: [
			...
			},
			{
				...
				fieldPath:
					"spec.enable_forward_proxy.tls_intercept.signing_cert_choice",
				options: [
	...
	},
	{
		...
		oneOfGroups: [
			...
			},
			{
				choiceField: "secret_info_oneof",
				fieldPath:
					"spec.routes[].request_cookies_to_add[].secret_value.secret_info_oneof",
				options: [
			...
			},
			{
				choiceField: "secret_info_oneof",
				fieldPath:
					"spec.routes[].request_headers_to_add[].secret_value.secret_info_oneof",
				options: [
			...
			},
			{
				choiceField: "secret_info_oneof",
				fieldPath:
					"spec.routes[].response_cookies_to_add[].secret_value.secret_info_oneof",
				options: [
			...
			},
			{
				choiceField: "secret_info_oneof",
				fieldPath:
					"spec.routes[].response_headers_to_add[].secret_value.secret_info_oneof",
				options: [
			...
			},
			{
				...
				fieldPath:
					"spec.routes[].route_destination.csrf_policy.allowed_domains",
				options: [
			...
			},
			{
				...
				fieldPath:
					"spec.routes[].route_destination.hash_policy[].policy_specifier",
				options: [
			...
			},
			{
				...
				fieldPath:
					"spec.routes[].route_destination.hash_policy[].cookie.httponly",
				options: [
			...
			},
			{
				...
				fieldPath:
					"spec.routes[].route_destination.hash_policy[].cookie.samesite",
				options: [
			...
			},
			{
				choiceField: "secure",
				fieldPath:
					"spec.routes[].route_destination.hash_policy[].cookie.secure",
				options: [
	...
	},
	{
		...
		oneOfGroups: [
			...
			},
			{
				...
				options: [
					"spec.local_ip.ip_address.auto",
					"spec.local_ip.ip_address.ip_address",
				],
			},
			{
				choiceField: "ver",
			...
			},
			{
				...
				fieldPath:
					"spec.local_ip.ip_address.virtual_network_type.vn_type_choice",
				options: [
