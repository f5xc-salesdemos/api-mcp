...
export const shapeTools: ParsedOperation[] = [
		...
		oneOfGroups: [
			{
				...
				fieldPath:
					"spec.allowlist_policy_content.ip_allowlist[].client_identifier_choice",
				options: [
	...
	},
	{
		...
		queryParameters: [
			{
				description:
					"Timestamp representing start date of the requested period in millieseconds.",
				in: "query",
				name: "from",
				required: false,
				schema: {
			...
			{
				description:
					"Timestamp representing end date of the requested period in millieseconds.",
				in: "query",
				name: "to",
				required: false,
				schema: {
	...
	},
	{
		...
		oneOfGroups: [
			...
			},
			{
				...
				fieldPath:
					"spec.cloudflare.js_insertion_rules.exclude_list[].domain_matcher_choice",
				options: [
			...
			},
			{
				...
				fieldPath:
					"spec.cloudflare.js_insertion_rules.exclude_list[].domain.domain_choice",
				options: [
			...
			},
			{
				...
				fieldPath:
					"spec.cloudflare.js_insertion_rules.exclude_list[].path.path_match",
				options: [
			...
			},
			{
				choiceField: "domain_matcher_choice",
				fieldPath:
					"spec.cloudflare.js_insertion_rules.rules[].domain_matcher_choice",
				options: [
			...
			},
			{
				choiceField: "domain_choice",
				fieldPath:
					"spec.cloudflare.js_insertion_rules.rules[].domain.domain_choice",
				options: [
			...
			},
			{
				...
				fieldPath:
					"spec.cloudflare.mobile_sdk_config.mobile_identifier.headers[].value_match",
				options: [
			...
			},
			{
				choiceField: "domain_matcher_choice",
				fieldPath:
					"spec.cloudflare.protected_endpoints[].domain_matcher_choice",
				options: [
			...
			},
			{
				...
				fieldPath:
					"spec.cloudflare.protected_endpoints[].mobile_client.mitigation",
				options: [
			...
			},
			{
				...
				fieldPath:
					"spec.cloudflare.protected_endpoints[].mobile_client.continue.add_header_choice",
				options: [
			...
			},
			{
				choiceField: "mitigation",
				fieldPath:
					"spec.cloudflare.protected_endpoints[].web_client.mitigation",
				options: [
			...
			},
			{
				choiceField: "add_header_choice",
				fieldPath:
					"spec.cloudflare.protected_endpoints[].web_client.continue.add_header_choice",
				options: [
			...
			},
			{
				...
				fieldPath:
					"spec.cloudflare.protected_endpoints[].web_mobile_client.mobile_mitigation",
				options: [
			...
			},
			{
				...
				fieldPath:
					"spec.cloudflare.protected_endpoints[].web_mobile_client.web_mitigation",
				options: [
			...
			},
			{
				choiceField: "value_match",
				fieldPath:
					"spec.cloudflare.trusted_clients[].http_header.headers[].value_match",
				options: [
			...
			},
			{
				...
				options: [
					"spec.cloudfront.disable_mobile_sdk",
					"spec.cloudfront.mobile_sdk_config",
				],
			},
			{
				choiceField: "domain_matcher_choice",
				fieldPath:
					"spec.cloudfront.js_insertion_rules.exclude_list[].domain_matcher_choice",
				options: [
			...
			},
			{
				choiceField: "domain_choice",
				fieldPath:
					"spec.cloudfront.js_insertion_rules.exclude_list[].domain.domain_choice",
				options: [
			...
			},
			{
				choiceField: "path_match",
				fieldPath:
					"spec.cloudfront.js_insertion_rules.exclude_list[].path.path_match",
				options: [
			...
			},
			{
				choiceField: "domain_matcher_choice",
				fieldPath:
					"spec.cloudfront.js_insertion_rules.rules[].domain_matcher_choice",
				options: [
			...
			},
			{
				choiceField: "domain_choice",
				fieldPath:
					"spec.cloudfront.js_insertion_rules.rules[].domain.domain_choice",
				options: [
			...
			},
			{
				choiceField: "value_match",
				fieldPath:
					"spec.cloudfront.mobile_sdk_config.mobile_identifier.headers[].value_match",
				options: [
			...
			},
			{
				choiceField: "domain_matcher_choice",
				fieldPath:
					"spec.cloudfront.protected_endpoints[].domain_matcher_choice",
				options: [
			...
			},
			{
				choiceField: "flow_label_choice",
				fieldPath:
					"spec.cloudfront.protected_endpoints[].flow_label.flow_label_choice",
				options: [
			...
			},
			{
				choiceField: "label_choice",
				fieldPath:
					"spec.cloudfront.protected_endpoints[].flow_label.authentication.label_choice",
				options: [
			...
			},
			{
				choiceField: "label_choice",
				fieldPath:
					"spec.cloudfront.protected_endpoints[].flow_label.flight.label_choice",
				options: [
					"spec.cloudfront.protected_endpoints[].flow_label.flight.checkin",
				],
			},
			{
				choiceField: "label_choice",
			...
			},
			{
				choiceField: "label_choice",
				fieldPath:
					"spec.cloudfront.protected_endpoints[].flow_label.search.label_choice",
				options: [
			...
			},
			{
				choiceField: "mitigation",
				fieldPath:
					"spec.cloudfront.protected_endpoints[].mobile_client.mitigation",
				options: [
			...
			},
			{
				choiceField: "add_header_choice",
				fieldPath:
					"spec.cloudfront.protected_endpoints[].mobile_client.continue.add_header_choice",
				options: [
			...
			},
			{
				choiceField: "mitigation",
				fieldPath:
					"spec.cloudfront.protected_endpoints[].web_client.mitigation",
				options: [
			...
			},
			{
				choiceField: "add_header_choice",
				fieldPath:
					"spec.cloudfront.protected_endpoints[].web_client.continue.add_header_choice",
				options: [
			...
			},
			{
				choiceField: "mobile_mitigation",
				fieldPath:
					"spec.cloudfront.protected_endpoints[].web_mobile_client.mobile_mitigation",
				options: [
			...
			},
			{
				choiceField: "web_mitigation",
				fieldPath:
					"spec.cloudfront.protected_endpoints[].web_mobile_client.web_mitigation",
				options: [
			...
			},
			{
				choiceField: "value_match",
				fieldPath:
					"spec.cloudfront.trusted_clients[].http_header.headers[].value_match",
				options: [
