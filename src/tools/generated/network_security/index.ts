...
export const network_securityTools: ParsedOperation[] = [
	{
		...
		oneOfGroups: [
			...
			},
			{
				choiceField: "port_value_type_choice",
				fieldPath:
					"spec.site_acl.fast_acl_rules[].port[].port_value_type_choice",
				options: [
	...
	},
	{
		...
		oneOfGroups: [
			...
			},
			{
				choiceField: "destination_choice",
				fieldPath:
					"spec.forward_proxy_pbr.forward_proxy_pbr_rules[].destination_choice",
				options: [
			...
			},
			{
				choiceField: "source_choice",
				fieldPath:
					"spec.forward_proxy_pbr.forward_proxy_pbr_rules[].source_choice",
				options: [
