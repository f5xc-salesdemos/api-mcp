...
export const cloud_infrastructureTools: ParsedOperation[] = [
	...
	},
	{
		...
		oneOfGroups: [
			...
			},
			{
				...
				fieldPath:
					"spec.aws_tgw_site.vpc_attachments.vpc_list[].routing_choice",
				options: [
			...
			},
			{
				choiceField: "routing_choice",
				fieldPath:
					"spec.azure_vnet_site.vnet_attachments.vnet_list[].routing_choice",
				options: [
	...
	{
		toolName:
			"f5xc-api-cloudinfrastructure-cloud-connect-reapply-vpc-attachment-create",
		method: "POST",
