	...
	},
	{
		...
		oneOfGroups: [
			...
			},
			{
				choiceField: "secret_info_oneof",
				fieldPath:
					"spec.webhook.http_config.auth_token.token.secret_info_oneof",
				options: [
			...
			},
			{
				choiceField: "secret_info_oneof",
				fieldPath:
					"spec.webhook.http_config.basic_auth.password.secret_info_oneof",
				options: [
	...
	},
	{
		...
		oneOfGroups: [
			...
			},
			{
				choiceField: "port_choice",
				fieldPath:
					"tcp_lb_request.advertise_custom.advertise_where[].port_choice",
				options: [
			...
			},
			{
				...
				fieldPath:
					"tcp_lb_request.advertise_custom.advertise_where[].virtual_network.vip_choice",
				options: [
			...
			},
			{
				choiceField: "choice",
				fieldPath:
					"tcp_lb_request.advertise_custom.advertise_where[].vk8s_service.choice",
				options: [
	...
	},
	{
		...
		oneOfGroups: [
			...
			},
			{
				...
				fieldPath:
					"spec.aws_cloud_watch_receiver.compression.compression_choice",
				options: [
			...
			},
			{
				choiceField: "secret_info_oneof",
				fieldPath:
					"spec.azure_event_hubs_receiver.connection_string.secret_info_oneof",
				options: [
			...
			},
			{
				choiceField: "secret_info_oneof",
				fieldPath:
					"spec.datadog_receiver.use_tls.mtls_enable.key_url.secret_info_oneof",
				options: [
			...
			},
			{
				choiceField: "secret_info_oneof",
				fieldPath:
					"spec.http_receiver.use_tls.mtls_enable.key_url.secret_info_oneof",
				options: [
			...
			},
			{
				choiceField: "secret_info_oneof",
				fieldPath:
					"spec.kafka_receiver.use_tls.mtls_enable.key_url.secret_info_oneof",
				options: [
			...
			},
			{
				choiceField: "secret_info_oneof",
				fieldPath:
					"spec.qradar_receiver.use_tls.mtls_enable.key_url.secret_info_oneof",
				options: [
			...
			},
			{
				choiceField: "secret_info_oneof",
				fieldPath:
					"spec.splunk_receiver.use_tls.mtls_enable.key_url.secret_info_oneof",
				options: [
	...
	},
	{
		...
		oneOfGroups: [
			...
			},
			{
				choiceField: "secret_info_oneof",
				fieldPath:
					"spec.syslog.tls_server.mtls_enable.key_url.secret_info_oneof",
				options: [
