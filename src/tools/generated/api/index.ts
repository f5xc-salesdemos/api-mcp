	...
	},
	{
		...
		oneOfGroups: [
			...
			},
			{
				choiceField: "secret_info_oneof",
				fieldPath:
					"spec.domains[].credentials[].api_key.value.secret_info_oneof",
				options: [
			...
			},
			{
				choiceField: "secret_info_oneof",
				fieldPath:
					"spec.domains[].credentials[].basic_auth.password.secret_info_oneof",
				options: [
			...
			},
			{
				choiceField: "secret_info_oneof",
				fieldPath:
					"spec.domains[].credentials[].bearer_token.token.secret_info_oneof",
				options: [
			...
			},
			{
				choiceField: "secret_info_oneof",
				fieldPath:
					"spec.domains[].credentials[].login_endpoint.json_payload.secret_info_oneof",
				options: [
	...
	},
	{
		...
		oneOfGroups: [
			...
			},
			{
				choiceField: "secret_info_oneof",
				fieldPath:
					"spec.code_base_integration.azure_repos.access_token.secret_info_oneof",
				options: [
			...
			},
			{
				choiceField: "secret_info_oneof",
				fieldPath:
					"spec.code_base_integration.bitbucket.passwd.secret_info_oneof",
				options: [
			...
			},
			{
				choiceField: "secret_info_oneof",
				fieldPath:
					"spec.code_base_integration.bitbucket_server.passwd.secret_info_oneof",
				options: [
			...
			},
			{
				choiceField: "secret_info_oneof",
				fieldPath:
					"spec.code_base_integration.github.access_token.secret_info_oneof",
				options: [
			...
			},
			{
				choiceField: "secret_info_oneof",
				fieldPath:
					"spec.code_base_integration.github_enterprise.access_token.secret_info_oneof",
				options: [
			...
			},
			{
				choiceField: "secret_info_oneof",
				fieldPath:
					"spec.code_base_integration.gitlab.access_token.secret_info_oneof",
				options: [
			...
			},
			{
				choiceField: "secret_info_oneof",
				fieldPath:
					"spec.code_base_integration.gitlab_enterprise.access_token.secret_info_oneof",
				options: [
	...
	},
	{
		...
		oneOfGroups: [
			...
			},
			{
				...
				options: [
					"spec.discovery_k8s.default_all",
					"spec.discovery_k8s.namespace_mapping",
				],
			},
			{
			...
			},
			{
				choiceField: "secret_info_oneof",
				fieldPath:
					"spec.discovery_k8s.access_info.kubeconfig_url.secret_info_oneof",
				options: [
