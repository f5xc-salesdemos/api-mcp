	...
	},
	{
		...
		oneOfGroups: [
			...
			},
			{
				...
				fieldPath:
					"spec.access_info.rest_auth_info.basic_auth.password.secret_info_oneof",
				options: [
			...
			},
			{
				...
				fieldPath:
					"spec.access_info.tls_config.cert_params.validation_params.trusted_ca_choice",
				options: [
			...
			},
			{
				choiceField: "trusted_ca_choice",
				fieldPath:
					"spec.access_info.tls_config.common_params.validation_params.trusted_ca_choice",
				options: [
			...
			},
			{
				choiceField: "secret_info_oneof",
				fieldPath:
					"spec.access_info.vault_auth_info.app_role_auth.secret_id.secret_info_oneof",
				options: [
	...
	},
	{
		...
		oneOfGroups: [
			...
			},
			{
				choiceField: "choice",
				fieldPath:
					"spec.user_restrictions[].user_restrictions.allow_list.custom_list[].choice",
				options: [
			...
			},
			{
				choiceField: "choice",
				fieldPath:
					"spec.user_restrictions[].user_restrictions.deny_list.custom_list[].choice",
				options: [
