...
const RESOURCE_PATTERNS: Array<{ pattern: RegExp; subcategory: Subcategory }> = [
  ...
  {
    pattern: /bot[-_]?infrastructure/i,
    subcategory: SUBCATEGORIES.BOT_DEFENSE,
  },
  ...
  {
    pattern: /client[-_]?side[-_]?defense/i,
    subcategory: SUBCATEGORIES.BOT_DEFENSE,
  },
  { pattern: /mobile[-_]?sdk/i, subcategory: SUBCATEGORIES.BOT_DEFENSE },
  {
    pattern: /mobile[-_]?base[-_]?config/i,
    subcategory: SUBCATEGORIES.BOT_DEFENSE,
  },
  {
    pattern: /mobile[-_]?integrator/i,
    subcategory: SUBCATEGORIES.BOT_DEFENSE,
  },
  {
    pattern: /mobile[-_]?app[-_]?shield/i,
    subcategory: SUBCATEGORIES.BOT_DEFENSE,
  },
  ...
  {
    pattern: /all[-_]?ns[-_]?metric/i,
    subcategory: SUBCATEGORIES.MONITORING,
  },
  ...
  {
    pattern: /active[-_]?network[-_]?polic/i,
    subcategory: SUBCATEGORIES.NETWORKING,
  },
  ...
  {
    pattern: /policy[-_]?based[-_]?routing/i,
    subcategory: SUBCATEGORIES.NETWORKING,
  },
  {
    pattern: /address[-_]?allocator/i,
    subcategory: SUBCATEGORIES.NETWORKING,
  },
  ...
  {
    pattern: /active[-_]?service[-_]?polic/i,
    subcategory: SUBCATEGORIES.SECURITY,
  },
  ...
  {
    pattern: /protocol[-_]?inspection/i,
    subcategory: SUBCATEGORIES.SECURITY,
  },
  {
    pattern: /get[-_]?security[-_]?config/i,
    subcategory: SUBCATEGORIES.SECURITY,
  },
  ...
  {
    pattern: /credential[-_]?stuffing/i,
    subcategory: SUBCATEGORIES.SECURITY,
  },
  ...
  // API Security
  {
    pattern: /^api[-_]?definition/i,
    subcategory: SUBCATEGORIES.API_SECURITY,
  },
  ...
  {
    pattern: /app[-_]?api[-_]?group/i,
    subcategory: SUBCATEGORIES.API_SECURITY,
  },
  {
    pattern: /api[-_]?endpoint[-_]?protection/i,
    subcategory: SUBCATEGORIES.API_SECURITY,
  },
  ...
  {
    pattern: /^ca[-_]?certificate/i,
    subcategory: SUBCATEGORIES.CERTIFICATES,
  },
  ...
  {
    pattern: /download[-_]?certificate/i,
    subcategory: SUBCATEGORIES.CERTIFICATES,
  },
  ...
  {
    pattern: /container[-_]?registry/i,
    subcategory: SUBCATEGORIES.KUBERNETES,
  },
  { pattern: /^replicaset/i, subcategory: SUBCATEGORIES.KUBERNETES },

  // Cloud Resources
  {
    pattern: /^cloud[-_]?credential/i,
    subcategory: SUBCATEGORIES.CLOUD_RESOURCES,
  },
  {
    pattern: /^cloud[-_]?region/i,
    subcategory: SUBCATEGORIES.CLOUD_RESOURCES,
  },
  {
    pattern: /^cloud[-_]?connect/i,
    subcategory: SUBCATEGORIES.CLOUD_RESOURCES,
  },
  {
    pattern: /^cloud[-_]?elastic/i,
    subcategory: SUBCATEGORIES.CLOUD_RESOURCES,
  },
  { pattern: /^cloud[-_]?link/i, subcategory: SUBCATEGORIES.CLOUD_RESOURCES },
  {
    pattern: /discover[-_]?vpc/i,
    subcategory: SUBCATEGORIES.CLOUD_RESOURCES,
  },

  // Load Balancing
  {
    pattern: /http[-_]?loadbalancer/i,
    subcategory: SUBCATEGORIES.LOAD_BALANCING,
  },
  {
    pattern: /tcp[-_]?loadbalancer/i,
    subcategory: SUBCATEGORIES.LOAD_BALANCING,
  },
  {
    pattern: /udp[-_]?loadbalancer/i,
    subcategory: SUBCATEGORIES.LOAD_BALANCING,
  },
  {
    pattern: /cdn[-_]?loadbalancer/i,
    subcategory: SUBCATEGORIES.LOAD_BALANCING,
  },
  {
    pattern: /create[-_]?http[-_]?load/i,
    subcategory: SUBCATEGORIES.LOAD_BALANCING,
  },
  {
    pattern: /create[-_]?tcp[-_]?load/i,
    subcategory: SUBCATEGORIES.LOAD_BALANCING,
  },
  ...
  {
    pattern: /dos[-_]?automitigation/i,
    subcategory: SUBCATEGORIES.LOAD_BALANCING,
  },
  ...
  {
    pattern: /^implicit[-_]?label/i,
    subcategory: SUBCATEGORIES.ORGANIZATION,
  },
  ...
  {
    pattern: /^api[-_]?credential/i,
    subcategory: SUBCATEGORIES.AUTHENTICATION,
  },
  ...
  {
    pattern: /forwarding[-_]?class/i,
    subcategory: SUBCATEGORIES.SERVICE_MESH,
  },
  ...
  {
    pattern: /^infraprotect/i,
    subcategory: SUBCATEGORIES.INFRASTRUCTURE_PROTECTION,
  },
  ...
  {
    pattern: /^protected[-_]?application/i,
    subcategory: SUBCATEGORIES.APPLICATIONS,
  },
  { pattern: /^app[-_]?inventory/i, subcategory: SUBCATEGORIES.APPLICATIONS },
  {
    pattern: /all[-_]?application[-_]?inventory/i,
    subcategory: SUBCATEGORIES.APPLICATIONS,
  },
  {
    pattern: /discovered[-_]?service/i,
    subcategory: SUBCATEGORIES.APPLICATIONS,
  },
  { pattern: /^discovery$/i, subcategory: SUBCATEGORIES.APPLICATIONS },
  {
    pattern: /protected[-_]?domain/i,
    subcategory: SUBCATEGORIES.APPLICATIONS,
  },
  {
    pattern: /mitigated[-_]?domain/i,
    subcategory: SUBCATEGORIES.APPLICATIONS,
  },
  {
    pattern: /detected[-_]?domain/i,
    subcategory: SUBCATEGORIES.APPLICATIONS,
  },
  { pattern: /domain[-_]?detail/i, subcategory: SUBCATEGORIES.APPLICATIONS },
  {
    pattern: /all[-_]?ns[-_]?service/i,
    subcategory: SUBCATEGORIES.APPLICATIONS,
  },
 ...
 */
export function getAllUsedSubcategories(tools: Array<{ domain: string; resource: string }>): Subcategory[] {
 ...
 */
export function getCategoryPath(domain: string, resource: string, tags: string[] = []): CategoryPath {
  ...
  return {
    ...
    directoryPath: subdivision ? `${kebabCase(domain)}/${kebabCase(subdivision)}` : kebabCase(domain),
  };
}
